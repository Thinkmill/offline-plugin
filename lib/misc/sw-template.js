...
function WebpackServiceWorker(params, helpers) {
  ...
  function addAllNormalized(cache, requests, options) {
    ...
    function requestAssets(requests) {
      return new Promise(function (resolve, reject) {
        ...
        function callRequest(list) {
          failures = [];
          async.eachLimit(list, 10, function (request, done) {
            ...
            return fetch(request, requestInit).then(fixRedirectedResponse).then(function (response) {
              ...
              failures.push({ err: e, request: request });
              return done();
            });
          }, function (err) {
            if (failures.length) {
              return callRequest(failures.map(function (f) {
                return f.request;
              }));
            }
    ...
    return requestAssets(requests).then(function (responses) {
